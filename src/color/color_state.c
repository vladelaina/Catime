...
#if ((CLOCK_IDM_GLOW_EFFECT >= CMD_COLOR_OPTIONS_BASE && CLOCK_IDM_GLOW_EFFECT <= CMD_COLOR_OPTIONS_END) || \
     (CLOCK_IDM_GLASS_EFFECT >= CMD_COLOR_OPTIONS_BASE && CLOCK_IDM_GLASS_EFFECT <= CMD_COLOR_OPTIONS_END) || \
     (CLOCK_IDM_NEON_EFFECT >= CMD_COLOR_OPTIONS_BASE && CLOCK_IDM_NEON_EFFECT <= CMD_COLOR_OPTIONS_END) || \
     (CLOCK_IDM_HOLOGRAPHIC_EFFECT >= CMD_COLOR_OPTIONS_BASE && CLOCK_IDM_HOLOGRAPHIC_EFFECT <= CMD_COLOR_OPTIONS_END) || \
     (CLOCK_IDM_LIQUID_EFFECT >= CMD_COLOR_OPTIONS_BASE && CLOCK_IDM_LIQUID_EFFECT <= CMD_COLOR_OPTIONS_END) || \
