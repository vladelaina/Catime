...
static const ConfigItemMeta CONFIG_METADATA[] = {
    ...
    {INI_SECTION_DISPLAY, "WINDOW_OPACITY", "100", CONFIG_TYPE_INT, CFG_OFFSET(windowOpacity), CFG_NO_SIZE, "Window opacity (10-100)"},
    ...
    {INI_SECTION_NOTIFICATION, "NOTIFICATION_MAX_OPACITY", "95", CONFIG_TYPE_INT, CFG_OFFSET(notificationMaxOpacity), CFG_NO_SIZE, "Notification opacity (10-100)"},
    ...
    {INI_SECTION_NOTIFICATION, "NOTIFICATION_FONT_SIZE", "25", CONFIG_TYPE_INT, CFG_OFFSET(notificationFontSize), CFG_NO_SIZE, "Notification text height ratio (10-60 percent)"},
