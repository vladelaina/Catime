...
static const ConfigItemMeta CONFIG_METADATA[] = {
    ...
    {INI_SECTION_GENERAL, "LANGUAGE", "English", CONFIG_TYPE_STRING, CFG_OFFSET(language), CFG_SIZE(language), "UI language"},
    ...
    {INI_SECTION_DISPLAY, "CLOCK_WINDOW_POS_X", "960", CONFIG_TYPE_INT, CFG_OFFSET(windowPosX), CFG_NO_SIZE, "Window X position"},
    ...
    {INI_SECTION_TIMER, "CLOCK_USE_24HOUR", "FALSE", CONFIG_TYPE_BOOL, CFG_OFFSET(use24Hour), CFG_NO_SIZE, "Use 24-hour format"},
    ...
    {INI_SECTION_TIMER, "STARTUP_MODE", "COUNTDOWN", CONFIG_TYPE_STRING, CFG_OFFSET(startupMode), CFG_SIZE(startupMode), "Startup mode"},
