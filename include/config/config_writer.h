...
#define CONFIG_WRITE_ITEM_CAPACITY 256
 ...
 * @param itemCapacity Number of entries available in items
...
/**
 * @brief Append animation speed configuration to an existing write item array
 * @param items Output array
 * @param itemCapacity Number of entries available in items
