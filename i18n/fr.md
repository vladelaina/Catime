...
# v1.5.0 est sorti ! 🎉 [Télécharger maintenant](https://github.com/vladelaina/Catime/releases/latest) - `Uniquement 995KB`！
</div>
...
<p align="center"> 
  Un outil Windows ultra-léger de compte à rebours et de minuteur Pomodoro, écrit en <b>C pur</b>, avec une interface propre et transparente,<br/>
  de nombreuses options de personnalisation, des actions rapides puissantes et une utilisation presque nulle des ressources système.
</p>
...
<div align="center" style="margin-bottom: 30px;">
  ...
  et
  <a href="https://qm.qq.com/q/vjCduOQILI" target="_blank" style="text-decoration: none; font-weight: bold; color: #12B7F5;">Groupe QQ（1079222265）</a>
</div>


## 🎨 Animations puissantes de la barre d'icones

Ton icone de la barre d'icones peut desormais prendre vie ! Catime apporte de puissantes possibilites d'animation personnalisee :

- **Animations personnalisees** : Prend en charge les images statiques comme **GIF**, **WebP** et **PNG**, **JPG** en tant qu'icones de la barre d'icones.
- **Affichage de l'etat du systeme** : Prend en charge l'affichage en temps reel de **l'utilisation CPU**, **l'utilisation memoire**, **le pourcentage de batterie** et l'etat de **Caps Lock**.
...
> [!TIP]
> Tu veux trouver plus d'animations de barre d'icones sympas ? Decouvre notre projet partenaire [MemeTray](https://github.com/MemeTray/MemeTray) !



## 💫 [Plugins](https://github.com/vladelaina/Catime-Plugins)

> Les plugins n'ont qu'a ecrire le contenu dans **output.txt**, et Catime s'occupe de l'afficher. C'est aussi simple que ca.
...
> [!TIP]
> Tu cherches plus de plugins utiles ? Regarde notre projet partenaire [Catime-Plugins](https://github.com/vladelaina/Catime-Plugins) !



## ❤️‍🔥 Restez avec nous

> **Donnez-nous un Star**, et temoignez de la progression continue de cet outil de temps minimaliste concu avec du C pur. Ne manquez pas les prochaines mises a jour !
  ...
  <table align="center">
    <tr>
      ...
      <td style="vertical-align: middle;">
        Le service gratuit de signature de code Windows est fourni par
        <a href="https://signpath.io">SignPath.io</a>, et les certificats sont parraines par
...
- GitHub Releases
  ...
  Telecharge la derniere version depuis [GitHub Releases](https://github.com/vladelaina/Catime/releases/latest).
...
## [📑 Guide d'utilisation](https://cati.me/guide)

- **Clic gauche sur l'icone de la barre d'icones** : Definir **Temps**
- **Clic droit sur l'icone de la barre d'icones** : Ouvrir **Menu**
- **Mode d'edition** : Glisser pour ajuster la position, molette pour zoomer, clic droit avec 🖱️ pour quitter le mode d'edition

> Le fichier de configuration est enregistre dans `%LOCALAPPDATA%\Catime\config.ini`

## ⚡ [Optimisation des polices](https://vladelaina.github.io/Catime/tools/font-tool/)

Utilise l'outil officiel [Outil de reduction des polices](https://vladelaina.github.io/Catime/tools/font-tool/) pour reduire la taille de tes polices personnalisees de **plus de 90%**.

> Comme Catime affiche principalement des nombres et des symboles (`0-9`、`:`、`.`), la plupart des caracteres de la police ne sont en fait pas necessaires.
>
> **Recommandation** : Conserve les fichiers de police d'origine comme sauvegarde. Les futures mises a jour du logiciel peuvent necessiter plus de caracteres.

## 🛠️ Developpement

**Pre-requis** : La compilation de Catime necessite MinGW et CMake.
...
# Windows - voir les indications de configuration ci-dessous
```

<details>
<summary>📋 Indications de configuration de l'environnement Windows</summary>

### 📦 Outils indispensables

| Outil | Description | Format de version recommande | Lien de telechargement |
| ---------- | ---------------------- | ------------------------------------------------------------- | --------------------------------------------------------------------------------- |
...
#### 1. Installer MinGW
1. Telecharge `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` depuis [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest)
2. Decompresse dans `C:\mingw64`
3. Ajoute `C:\mingw64\bin` a la variable d'environnement systeme `PATH` :
   - Ouvrir : `Panneau de configuration → Systeme → Parametres systemes avances → Variables d'environnement`
   - Dans les **variables systeme**, trouve `Path` puis clique sur "Modifier"
   - Ajouter : `C:\mingw64\bin`

#### 2. Installer CMake
1. Telecharge et lance `cmake-<version>-windows-x86_64.msi` depuis [CMake](https://cmake.org/download/)
2. Pendant l'installation, selectionne "Add CMake to the system PATH"
...
# 🎁 [Soutenir Catime](https://cati.me/support)
...
## [✨ Remerciements](https://cati.me/#thanks)

Merci spécial à [猫屋敷梨梨Official](https://space.bilibili.com/26087398) pour le magnifique design des icônes.

> Merci spécial aux contributeurs suivants (par ordre chronologique)：
...
## 🗝️ Mention de droits d'auteur
Ce projet est publié sous la licence open-source Apache License 2.0.

Mention du copyright des icônes：
- Les icônes du logiciel créées par [猫屋敷梨梨Official](https://space.bilibili.com/26087398) et tous les droits sont réservés. Sans l'autorisation explicite de l'auteur original, elles ne peuvent pas être utilisées à des fins commerciales.
Licence des polices：
- MIT：
...
- Auteur：[猫屋敷梨梨Official](https://space.bilibili.com/26087398)
  - Liens vers les fonds d'écran dynamiques：[猫屋敷梨梨 « là où se trouvent les étoiles » illustration (version de nuit)](https://steamcommunity.com/sharedfiles/filedetails/?id=3171487185) et [猫屋敷梨梨- « là où se trouvent les étoiles » illustration (version du crépuscule)](https://steamcommunity.com/sharedfiles/filedetails/?id=3171483657)
---
<div align="center">
