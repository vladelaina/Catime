...
<!-- Описание проекта + иконка ракеты -->
<p align="center" style="font-size: 18px; margin-bottom: 30px;">
  🎉 Не требует установки или настройки — просто дважды щелкните, чтобы начать. <br/>
  🌸 Чистый и элегантный интерфейс, плавное управление. <br/>
  🚀 Мощные сочетания клавиш для повышения эффективности работы.
</p>

<p align="center" style="font-size: 16px; color: #666; margin-bottom: 20px;">
  Сверхлёгкий инструмент таймера для Windows с функцией помодоро, <br/>
  прозрачным интерфейсом и множеством опций настройки, <br/>
  занимает всего несколько МБ памяти и почти не нагружает процессор, <br/>
  элегантно помогая вам управлять временем на Windows.
</p>

<p align="center"><a href="https://vladelaina.github.io/Catime/">Официальный сайт</a> · <a href="https://vladelaina.github.io/Catime/guide.html">Руководство</a> · <a href="https://vladelaina.github.io/Catime/about.html">О проекте</a> · <a href="https://github.com/users/vladelaina/projects/2/views/1">Доска проекта</a> · <a href="https://github.com/vladelaina/Catime/issues">Обратная связь</a></p>
...
<div align="center" style="margin-bottom: 30px;">
  ...
  и 
  <a href="https://qm.qq.com/q/LgscIMw9i0" target="_blank" style="text-decoration: none; font-weight: bold; color: #12B7F5;">QQ-группа</a>
</div>

## [🌟 Основные функции](https://vladelaina.github.io/Catime/#core-features)

- **Минималистичный дизайн**: прозрачный интерфейс, кликабельный фон, свободное перетаскивание и изменение размера, отсутствие сложных графических настроек, ощущение, что приложение не запущено отдельно.
- **Гибкий таймер**: быстрые предустановки, ввод пользовательского времени, отображение текущего времени (12/24-часовой формат), обратный отсчёт, прямой отсчёт, помодоро.
- **Действия по таймауту**: отображение сообщения, показ текущего времени, прямой отсчёт, блокировка экрана, открытие файлов/приложений, открытие веб-сайтов, выключение, перезагрузка.
- **Широкие возможности настройки**: 47 шрифтов, 15 предустановленных цветов, поддержка пользовательских цветов, выбор палитры, предварительный просмотр в реальном времени.

## 📥 Скачать

[<img src="https://get.microsoft.com/images/ru-ru%20dark.svg" alt="Скачать из Microsoft" height="104">](https://apps.microsoft.com/detail/9n3mzdf1z34v?referrer=appbadge&launch=true&mode=full)
#### 🪟 Winget
...
Скачайте последнюю версию из [GitHub Releases](https://github.com/vladelaina/Catime/releases/latest).

## [💡 Сценарии использования](https://vladelaina.github.io/Catime/#use-cases)

- 👔 Обратный отсчёт до конца работы
- 🍅 Метод помодоро
...
- ⏰ Таймер для открытия:
  ...
  - 📄 Файлов
  - 📝 Пакетных скриптов
  - 🔄 Планового выключения/перезагрузки
- 📊 Обратный отсчёт для презентаций
- 🕰️ Настольные часы
- ⏱️ Прямой/обратный таймер

## [📑 Руководство пользователя](https://vladelaina.github.io/Catime/guide)

- **Левый клик по иконке в трее**: настройка **времени**
- **Правый клик по иконке в трее**: открытие **меню**
- **Режим редактирования**: перетаскивание для изменения позиции, колесо мыши для изменения размера, 🖱️ правый клик для выхода из режима редактирования

> Файл конфигурации сохраняется в `C:\Users\<username>\AppData\Local\Catime\config.ini`

## 🛠️ [Сборка из исходного кода](https://www.bilibili.com/video/BV1H97LzVEee)
...
| Инструмент | Описание              | Рекомендуемый формат версии                           | Ссылка для скачивания                                                              |
|------------|-----------------------|------------------------------------------------------|-----------------------------------------------------------------------------------|
| **MinGW**  | Компилятор GCC        | `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` | [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest) |
| **xmake**  | Инструмент сборки     | `xmake-v<version>-win64.exe`                         | [xmake](https://github.com/xmake-io/xmake/releases/latest)                      |

<details>
  <summary>2. Установка инструментов</summary>

#### 📦 2.1 Установка [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest)

1. **Распакуйте MinGW в указанную папку**
   Пример: распакуйте `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` в:
...
2. **Настройка переменной PATH**
   ...
   * Найдите переменную `Path` в **системных переменных**, нажмите "Изменить"
...
3. **Проверка установки**
   ...
   Откройте командную строку (Win + R → введите `cmd` → Enter) и введите:

   ```bash
   gcc --version
   ```

   Если версия отображается корректно, установка MinGW завершена ✅

#### 📦 2.2 Установка [xmake](https://github.com/xmake-io/xmake/releases/latest)

1. Запустите `xmake-v<version>-win64.exe` для установки
2. Во время установки PATH будет настроен автоматически (если этого не произошло, вручную добавьте папку `bin` из директории установки xmake в PATH)
...
Если оба инструмента корректно отображают версии, настройка завершена 🎉
</details>

### 4. Сборка с помощью xmake

В корневой папке проекта откройте командную строку и используйте следующие команды:

```bash
xmake         # Скомпилировать проект
xmake run     # Скомпилировать и запустить проект
xmake clean   # Очистить файлы сборки
```
...
## 🗝️ Заявление об авторских правах

Проект распространяется под открытой лицензией Apache License 2.0.

Заявление об авторских правах на иконки:
- Иконка программы создана [猫屋敷梨梨Official](https://space.bilibili.com/26087398), все права защищены. Использование в коммерческих целях без явного разрешения автора запрещено.
...
Обои:
- Автор: [猫屋敷梨梨Official](https://space.bilibili.com/26087398)
  - Ссылка на динамические обои: [Wallpaper Engine](https://steamcommunity.com/sharedfiles/filedetails/?id=3171487185)
