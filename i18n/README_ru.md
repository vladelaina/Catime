...
- **Широкие возможности настройки**: 13 шрифтов, 15 предустановленных цветов, поддержка пользовательских цветов, выбор палитры, предварительный просмотр в реальном времени.
...
| **CMake**  | Инструмент сборки     | `cmake-<version>-windows-x86_64.msi`                         | [CMake](https://cmake.org/download/)                      |
...
#### 📦 2.2 Установка [CMake](https://cmake.org/download/)

1. Запустите `cmake-<version>-windows-x86_64.msi` для установки
2. Во время установки PATH будет настроен автоматически (если этого не произошло, вручную добавьте папку `bin` из директории установки CMake в PATH)
...
```bash
CMake         # Скомпилировать проект
CMake run     # Скомпилировать и запустить проект
CMake clean   # Очистить файлы сборки
```
