...
# v1.5.0 опубликована! 🎉 [Скачать сейчас](https://github.com/vladelaina/Catime/releases/latest) - `Только 995KB`！
</div>
...
<p align="center"> 
  Ультралёгкий инструмент для Windows: таймер обратного отсчёта и Pomodoro, написанный на <b>чистом C</b>, с аккуратным и прозрачным интерфейсом,<br/>
  широкими возможностями настройки, мощными быстрыми действиями и практически без использования системных ресурсов.
</p>
...
<div align="center" style="margin-bottom: 30px;">
  ...
  и
  <a href="https://qm.qq.com/q/vjCduOQILI" target="_blank" style="text-decoration: none; font-weight: bold; color: #12B7F5;">Группа QQ（1079222265）</a>
</div>


## 🎨 Мощные анимации в системном трее

Значок в системном трее теперь может «ожить»! Catime добавляет мощные возможности для пользовательских анимаций:

- **Пользовательские анимации**: поддерживаются статические изображения, такие как **GIF**, **WebP**, а также **PNG**, **JPG**, в качестве значков трея.
- **Отображение состояния системы**: поддерживается отображение в реальном времени **загрузки CPU**, **использования памяти**, **процента заряда батареи** и состояния **Caps Lock**.
...
> [!TIP]
> Хотите найти больше интересных анимаций трея? Посмотрите наш проект [MemeTray](https://github.com/MemeTray/MemeTray)!



## 💫 [Плагины](https://github.com/vladelaina/Catime-Plugins)

> Плагины должны только записать содержимое в **output.txt**, а Catime отобразит его для вас. Вот и всё.
...
> [!TIP]
> Хотите найти больше полезных плагинов? Посмотрите наш проект [Catime-Plugins](https://github.com/vladelaina/Catime-Plugins)!



## ❤️‍🔥 Следите за нами дальше

> **Поставьте нам Star**, и посмотрите, как этот минималистичный инструмент времени, сделанный на чистом C, продолжает развиваться. Не пропускайте будущие обновления!
  ...
  <table align="center">
    <tr>
      ...
      <td style="vertical-align: middle;">
        Бесплатный сервис подписи кода для Windows предоставляется
        <a href="https://signpath.io">SignPath.io</a>, а сертификаты спонсируются
...
## [📑 Руководство по использованию](https://cati.me/guide)

- **Левый клик по значку трея**：Установить **Время**
- **Правый клик по значку трея**：Открыть **Меню**
- **Режим редактирования**：Перетащите, чтобы изменить позицию, колесо мыши для масштаба, правый клик 🖱️ чтобы выйти из режима редактирования

> Файл конфигурации сохраняется в `%LOCALAPPDATA%\Catime\config.ini`

## ⚡ [Оптимизация шрифтов](https://vladelaina.github.io/Catime/tools/font-tool/)

Используйте официальный [инструмент для упрощения шрифтов](https://vladelaina.github.io/Catime/tools/font-tool/), чтобы уменьшить размер ваших пользовательских шрифтов на **более чем 90%**.

> Так как Catime в основном отображает числа и символы (`0-9`、`:`、`.`), большинство символов шрифтов на самом деле не нужно.
>
> **Рекомендация**: Сохраняйте исходные файлы шрифтов в качестве резервной копии. В будущих обновлениях ПО может потребоваться больше символов.

## 🛠️ Разработка

**Предварительные требования**: для сборки Catime нужны MinGW и CMake.
...
# Windows - см. описание конфигурации ниже
```

<details>
<summary>📋 Настройка среды Windows</summary>

### 📦 Необходимые инструменты

| Инструмент | Описание | Рекомендуемый формат версии | Ссылка для загрузки |
| ---------- | ---------------------- | ------------------------------------------------------------- | --------------------------------------------------------------------------------- |
...
#### 1. Установить MinGW
1. Скачайте `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` с [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest)
2. Распакуйте в `C:\mingw64`
3. Добавьте `C:\mingw64\bin` в системную переменную окружения `PATH`:
   ...
   - Добавьте: `C:\mingw64\bin`

#### 2. Установить CMake
1. Скачайте и запустите `cmake-<version>-windows-x86_64.msi` с [CMake](https://cmake.org/download/)
2. В процессе установки выберите “Add CMake to the system PATH”
...
# 🎁 [Поддержать Catime](https://cati.me/support)
...
## [✨ Благодарности](https://cati.me/#thanks)

Особая благодарность [猫屋敷梨梨Official](https://space.bilibili.com/26087398) за великолепный дизайн иконок.
...
Этот проект распространяется по открытой лицензии Apache License 2.0.

Уведомление об авторских правах на значки：
- Значки программ созданы [猫屋敷梨梨Official](https://space.bilibili.com/26087398) и все права защищены. Без явного разрешения первоначального автора запрещено использовать их для любых коммерческих целей.
Лицензия на шрифты：
- MIT：
...
- Автор：[猫屋敷梨梨Official](https://space.bilibili.com/26087398)
  - Ссылки на динамические обои：[猫屋敷梨梨 « Там, где звезды » иллюстрация (ночная версия)](https://steamcommunity.com/sharedfiles/filedetails/?id=3171487185) и [猫屋敷梨梨-« Там, где звезды » иллюстрация (сумеречная версия)](https://steamcommunity.com/sharedfiles/filedetails/?id=3171483657)
---
<div align="center">
