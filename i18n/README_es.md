...
<!-- Descripción del proyecto + icono de cohete -->
...
1. **Extrae MinGW en una ubicación específica**
   Ejemplo: extrae `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` en:

   ```
   C:\mingw64
   ```

2. **Configurar la variable de entorno del sistema PATH**
...
3. **Verificar la instalación**
   ...
   Abrir el símbolo del sistema(Win + R → escribir `cmd` → presionar Enter), ingresar:
