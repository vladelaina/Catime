...
# v1.5.0 ya está publicado! 🎉 [Descargar ahora](https://github.com/vladelaina/Catime/releases/latest) - `Solo 995KB`！
</div>
...
<p align="center"> 
  Una herramienta ultraligera de Windows para cuenta atrás y temporizador Pomodoro, escrita en <b>C puro</b>, con una interfaz limpia y transparente,<br/>
  muchas opciones de personalización, potentes acciones rápidas y que casi no consume recursos del sistema.
</p>
...
<div align="center" style="margin-bottom: 30px;">
  ...
  y al
  <a href="https://qm.qq.com/q/vjCduOQILI" target="_blank" style="text-decoration: none; font-weight: bold; color: #12B7F5;">Grupo de QQ（1079222265）</a>
</div>


## 🎨 Animaciones potentes de la bandeja

Tu icono de la bandeja ahora puede "cobrar vida"! Catime trae potentes capacidades de animacion personalizada:

- **Animaciones personalizadas**: Admite usar **GIF**, **WebP** y tambien imagenes estaticas como **PNG** y **JPG** como iconos de la bandeja.
- **Visualizacion del estado del sistema**: Admite mostrar en tiempo real **uso de la CPU**, **uso de memoria**, **porcentaje de bateria** y el estado de **Bloq Mayus (Caps Lock)**.
...
> [!TIP]
> ?Buscas mas animaciones divertidas de la bandeja? Consulta nuestro proyecto complementario [MemeTray](https://github.com/MemeTray/MemeTray)!



## 💫 [Complementos](https://github.com/vladelaina/Catime-Plugins)

> Los complementos solo necesitan escribir el contenido en **output.txt** y Catime se encargara de mostrarlo. Asi de simple.
...
> [!TIP]
> ?Quieres encontrar mas complementos utiles? Mira nuestro proyecto complementario [Catime-Plugins](https://github.com/vladelaina/Catime-Plugins)!



## ❤️‍🔥 Mantente al tanto con nosotros

> **Danos un Star** y observa como esta herramienta de tiempo minimalista hecha con C puro sigue evolucionando. No te pierdas las proximas actualizaciones.
  ...
  <table align="center">
    <tr>
      ...
      <td style="vertical-align: middle;">
        El servicio gratuito de firma de codigo para Windows lo ofrece
        <a href="https://signpath.io">SignPath.io</a>, y los certificados estan patrocinados por
...
- GitHub Releases
  ...
  Descarga la ultima version desde [GitHub Releases](https://github.com/vladelaina/Catime/releases/latest).
...
## [📑 Guia de uso](https://cati.me/guide)

- **Clic izquierdo en el icono de la bandeja**: Configura **Tiempo**
- **Clic derecho en el icono de la bandeja**: Abre **Menu**
- **Modo de edicion**: Arrastra para ajustar la posicion, rueda del mouse para hacer zoom, clic derecho con 🖱️ para salir del modo de edicion

> El archivo de configuracion se guarda en `%LOCALAPPDATA%\Catime\config.ini`

## ⚡ [Optimizacion de fuentes](https://vladelaina.github.io/Catime/tools/font-tool/)

Usa la herramienta oficial [Herramienta para simplificar fuentes](https://vladelaina.github.io/Catime/tools/font-tool/) para reducir el tamaño de tus fuentes personalizadas en **mas del 90%**.

> Como Catime principalmente muestra numeros y simbolos (`0-9`、`:`、`.`), realmente no se necesitan la mayoria de los caracteres de la fuente.
>
> **Recomendacion**: Conserva los archivos originales de fuentes como copia de seguridad. Las futuras actualizaciones del software pueden requerir mas caracteres.

## 🛠️ Desarrollo

**Requisitos previos**: Para compilar Catime se necesitan MinGW y CMake.
...
# Windows - ver notas de configuracion abajo
```

<details>
<summary>📋 Instrucciones de configuracion del entorno de Windows</summary>

### 📦 Herramientas indispensables

| Herramienta | Descripcion | Formato recomendado de version | Enlace de descarga |
| ---------- | ---------------------- | ------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| **MinGW**  | Compilador de GCC | `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` | [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest) |
| **CMake**  | Herramienta de construccion | `cmake-<version>-windows-x86_64.msi` | [CMake](https://cmake.org/download/) |

### 🔧 Pasos de instalacion

#### 1. Instalar MinGW
1. Descarga `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` desde [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest)
2. Extrae a `C:\mingw64`
3. Agrega `C:\mingw64\bin` a la variable de entorno del sistema `PATH`:
   - Abrir: `Panel de control → Sistema → Configuracion avanzada del sistema → Variables de entorno`
   - En **variables del sistema**, busca `Path` y haz clic en "Editar"
   - Agregar: `C:\mingw64\bin`

#### 2. Instalar CMake
1. Descarga y ejecuta `cmake-<version>-windows-x86_64.msi` desde [CMake](https://cmake.org/download/)
2. Durante la instalacion, selecciona “Add CMake to the system PATH”
...
# 🎁 [Apoya a Catime](https://cati.me/support)
...
## [✨ Créditos](https://cati.me/#thanks)

Agradecimiento especial a [猫屋敷梨梨Official](https://space.bilibili.com/26087398) por el excelente diseño de los iconos.

> Agradecimientos especiales a los siguientes colaboradores (en orden cronológico)：
...
Este proyecto se publica bajo la licencia open-source Apache License 2.0.

Aviso de derechos de autor de los iconos：
- Los iconos del software creados por [猫屋敷梨梨Official](https://space.bilibili.com/26087398) y todos los derechos reservados. Sin el permiso explícito del autor original, no se permite su uso para fines comerciales.
Licencia de fuentes：
- MIT：
...
- Autor：[猫屋敷梨梨Official](https://space.bilibili.com/26087398)
  - Enlaces de fondos de pantalla dinámicos：[猫屋敷梨梨「donde están las estrellas」Artwork (versión nocturna)](https://steamcommunity.com/sharedfiles/filedetails/?id=3171487185) y [猫屋敷梨梨-「donde están las estrellas」Artwork (versión del crepúsculo)](https://steamcommunity.com/sharedfiles/filedetails/?id=3171483657)
---
<div align="center">
