...
<p align="center">A simple Windows countdown timer with Pomodoro functionality, featuring a transparent interface and extensive customization options.</p>

---

![Catime](../Images/catime.gif)

[**简体中文**](../README.md) | [**繁體中文**](README_zh-tw.md) | **English**| [**日本語**](README_ja.md) | [**Español**](README_es.md) | [**Português**](README_pt-br.md) | [**한국어**](README_ko-kr.md) | [**Deutsch**](README_de.md) | [**French**](README_fr.md)

## 🌟 Features

- **Minimalist Design**: Transparent interface, click-through support, resizable, multi-language support
- **Rich Fonts**: 14 Nerd Fonts with real-time preview
...
- **UI Customization**: 9 preset colors, custom RGB/HEX, real-time preview

## 📑 Usage Instructions

- **Left-click on the tray icon**: Set timer  
- **Right-click on the tray icon**: Open settings menu  
- **Edit Mode**: Drag to adjust position, scroll to resize, 🖱️ right-click to exit edit mode  

### 🛠️ Configuration File
Settings are saved in `C:\Users\YourUsername\AppData\Local\Catime\config.txt`
...
### Image Copyright:
- The program icon `catime.ico` and demo image `Images/catime.png` were created by [猫屋敷梨梨Official](https://space.bilibili.com/26087398) and all rights are reserved.
- These images cannot be used for commercial purposes without explicit permission from the original creator.
