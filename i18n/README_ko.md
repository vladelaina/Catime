...
<p align="center" style="font-size: 18px; margin-bottom: 30px;">
  🎉 설치나 설정 필요 없음 — 더블 클릭으로 즉시 사용 가능.<br/>
  🌸 깔끔하고 우아한 인터페이스, 부드러운 조작.<br/>
  🚀 강력한 키보드 단축키로 작업 효율성 향상.
</p>

<p align="center" style="font-size: 16px; color: #666; margin-bottom: 20px;">
  초경량 Windows 카운트다운 도구로, 토마토 타이머 기능 포함,<br/>
  투명 인터페이스와 풍부한 사용자 정의 옵션 제공,<br/>
  단 몇 MB의 메모리만 사용하며 CPU 자원을 거의 소모하지 않음,<br/>
  Windows에서 시간을 우아하게 관리할 수 있도록 도와줌.
</p>

<p align="center"><a href="https://vladelaina.github.io/Catime/">공식 웹사이트</a> · <a href="https://vladelaina.github.io/Catime/guide.html">가이드</a> · <a href="https://vladelaina.github.io/Catime/about.html">소개</a> · <a href="https://github.com/users/vladelaina/projects/2/views/1">프로젝트 보드</a> · <a href="https://github.com/vladelaina/Catime/issues">피드백</a></p>
...
<div align="center" style="margin-bottom: 30px;">
  ...
  와 
  <a href="https://qm.qq.com/q/LgscIMw9 i0" target="_blank" style="text-decoration: none; font-weight: bold; color: #12B7F5;">QQ 그룹</a>에 가입하세요
</div>

## [🌟기능 특징](https://vladelaina.github.io/Catime/#core-features)
...
[<img src="https://get.microsoft.com/images/zh-cn%20dark.svg" alt="마이크로소프트에서 다운로드" height="104">](https://apps.microsoft.com/detail/9n3mzdf1z34v?referrer=appbadge&launch=true&mode=full)
#### 🪟 Winget
...
## [💡사용 시나리오](https://vladelaina.github.io/Catime/#use-cases)
...
## [📑사용자 가이드](https://vladelaina.github.io/Catime/guide)

- **트레이 아이콘 왼쪽 클릭**: **시간** 설정
- **트레이 아이콘 오른쪽 클릭**: **메뉴** 설정
- **편집 모드**: 드래그로 위치 조정, 휠로 크기 조정, 🖱️오른쪽 클릭으로 편집 모드 종료

> 설정 파일은 `C:\Users\<username>\AppData\Local\Catime\config.ini`에 저장됨

## 🛠️ [소스 코드에서 빌드](https://www.bilibili.com/video/BV1H97LzVEee)
...
#### <img src="../Images/windows.svg"  height="25" />Windows
  ...
  #### 📦 2.1 [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest) 설치

  1. **MinGW를 특정 위치에 압축 해제**
     예: `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z`를 다음 위치에 압축 해제:
  ...
  3. **설치 확인**
     ...
     명령 프롬프트 열기(Win + R → `cmd` 입력 → Enter), 입력:
...
## [✨감사 인사](https://vladelaina.github.io/Catime/#thanks) 

다음 기여자들에게 특별히 감사드립니다(시간순):
<table>
  <tbody>
    <tr>
      ...
      <td align="center" valign="top" width="14.28%">
        <a href="https://www.diandiapp.com/"><img src="https://github.com/user-attachments/assets/ed3ad284-d4f6-456f-a451-0d4c3cba05a4" width="100px;" alt="点点进度作者"/><br /><sub><b>点点进度作者</b></sub></a><br />
      </td>
      <td align="center" valign="top" width="14.28%">
...
이 프로젝트는 Apache License 2.0 오픈소스 라이선스에 따라 배포됩니다.

아이콘 저작권 성명:
- 소프트웨어 아이콘은 [猫屋敷梨梨Official](https://space.bilibili.com/26087398)에 의해 제작되었으며, 모든 권리는 원작자에게 있습니다. 원작자의 명시적 허가 없이 상업적 목적으로 사용될 수 없습니다.
...
- 저자: [猫屋敷梨梨Official](https://space.bilibili.com/26087398)
    - 동적 배경화면 링크: [Wallpaper Engine](https://steamcommunity.com/sharedfiles/filedetails/?id=3171487185)
---
