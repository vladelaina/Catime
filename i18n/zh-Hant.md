...
<div align="center" style="margin-bottom: 30px;">
  ...
  與 
  <a href="https://qm.qq.com/q/vjCduOQILI" target="_blank" style="text-decoration: none; font-weight: bold; color: #12B7F5;">QQ 群（1079222265）</a>
</div>
...
> 插件只需要把內容寫入 output.txt，Catime 負責顯示出來，就這麼簡單。
...
> [!TIP]
> 想找更多實用插件？可以看看我們的配套項目 [Catime-Plugins](https://github.com/vladelaina/Catime-Plugins)！
...
```bash
git clone [https://github.com/vladelaina/Catime.git](https://github.com/vladelaina/Catime.git)
cd Catime
