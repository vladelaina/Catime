...
# v1.5.0 já foi lançado! 🎉 [Baixar agora](https://github.com/vladelaina/Catime/releases/latest) - `Apenas 995KB`！
</div>
...
<p align="center"> 
  Um utilitário ultraleve para Windows de contagem regressiva e temporizador Pomodoro, escrito em <b>C puro</b>, com uma interface limpa e transparente,<br/>
  muitas opções de personalização, ações rápidas poderosas e praticamente sem consumir recursos do sistema.
</p>
...
## 🎨 Animacoes fortes da bandeja

O seu icone da bandeja agora pode "ganhar vida"! O Catime traz capacidades poderosas para animacao personalizada:

- **Animacoes personalizadas**: suporta usar **GIF**, **WebP** e imagens estaticas como **PNG** e **JPG** como icones da bandeja.
- **Exibicao do estado do sistema**: suporta exibir em tempo real **uso de CPU**, **uso de memoria**, **percentual de bateria** e o status de **Caps Lock**.
...
> [!TIP]
> Quer encontrar mais animacoes divertidas de bandeja? Confira nosso projeto relacionado [MemeTray](https://github.com/MemeTray/MemeTray)!



## 💫 [Plugins](https://github.com/vladelaina/Catime-Plugins)

> Os plugins so precisam escrever o conteudo em **output.txt**, e o Catime cuidara de exibir. E so isso.
...
> [!TIP]
> Quer encontrar mais plugins uteis? Veja nosso projeto relacionado [Catime-Plugins](https://github.com/vladelaina/Catime-Plugins)!



## ❤️‍🔥 Continue acompanhando a gente

> **Nos deem um Star** e veja esta ferramenta minimalista de tempo feita com C puro evoluindo continuamente. Nao perca as futuras atualizacoes!
  ...
  <table align="center">
    <tr>
      ...
      <td style="vertical-align: middle;">
        O servico gratuito de assinatura de codigo para Windows e fornecido por
        <a href="https://signpath.io">SignPath.io</a>, e os certificados sao patrocinados por
...
- GitHub Releases
  ...
  Baixe a ultima versao em [GitHub Releases](https://github.com/vladelaina/Catime/releases/latest).
...
- **Clique esquerdo no icone da bandeja**：Defina **Tempo**
- **Clique direito no icone da bandeja**：Abra **Menu**
- **Modo de edicao**：Arraste para ajustar a posicao, roda do mouse para dar zoom, clique direito com 🖱️ para sair do modo de edicao

> O arquivo de configuracao e salvo em `%LOCALAPPDATA%\Catime\config.ini`

## ⚡ [Otimizacao de fontes](https://vladelaina.github.io/Catime/tools/font-tool/)

Use a ferramenta oficial [Ferramenta de reducao de fontes](https://vladelaina.github.io/Catime/tools/font-tool/) para reduzir o tamanho das suas fontes personalizadas em **mais de 90%**.

> Como o Catime mostra principalmente numeros e simbolos (`0-9`、`:`、`.`), a maioria dos caracteres da fonte nao e, na verdade, necessaria.
>
> **Recomendacao**: Mantenha os arquivos originais da fonte como backup. Futuras atualizacoes do software podem exigir mais caracteres.

## 🛠️ Desenvolvimento

**Requisitos**: Para compilar o Catime, e necessario MinGW e CMake.
...
# Windows - ver as notas de configuracao abaixo
```

<details>
<summary>📋 Instrucoes de configuracao do ambiente Windows</summary>

### 📦 Ferramentas indispensaveis

| Ferramenta | Descricao | Formato recomendado da versao | Link de download |
| ---------- | ---------------------- | ------------------------------------------------------------- | --------------------------------------------------------------------------------- |
...
| **CMake**  | Ferramenta de build | `cmake-<version>-windows-x86_64.msi` | [CMake](https://cmake.org/download/) |

### 🔧 Passos de instalacao

#### 1. Instalar MinGW
1. Baixe `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` em [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest)
2. Extraia para `C:\mingw64`
3. Adicione `C:\mingw64\bin` a variavel de ambiente do sistema `PATH`:
   - Abrir: `Painel de controle → Sistema → Configuracoes avancadas do sistema → Variaveis de ambiente`
   - Em **variaveis do sistema**, encontre `Path` e clique em "Editar"
   - Adicionar: `C:\mingw64\bin`

#### 2. Instalar CMake
1. Baixe e execute `cmake-<version>-windows-x86_64.msi` em [CMake](https://cmake.org/download/)
2. Durante a instalacao, selecione "Add CMake to the system PATH"
...
# 🎁 [Apoie o Catime](https://cati.me/support)
...
Agradecimento especial a [猫屋敷梨梨Official](https://space.bilibili.com/26087398) pelo excelente design dos ícones.

> Agradecimentos especiais aos seguintes contribuidores (em ordem cronológica)：
...
Aviso de direitos autorais dos ícones：
- Os ícones do software foram criados por [猫屋敷梨梨Official](https://space.bilibili.com/26087398) e todos os direitos são reservados. Sem a autorização explícita do autor original, não é permitido utilizá-los para qualquer finalidade comercial.
Licença das fontes：
- MIT：
...
- Autor：[猫屋敷梨梨Official](https://space.bilibili.com/26087398)
  - Links para papéis de parede dinâmicos：[猫屋敷梨梨 « onde estão as estrelas » ilustração (versão noturna)](https://steamcommunity.com/sharedfiles/filedetails/?id=3171487185) e [猫屋敷梨梨- « onde estão as estrelas » ilustração (versão do crepúsculo)](https://steamcommunity.com/sharedfiles/filedetails/?id=3171483657)
---
<div align="center">
