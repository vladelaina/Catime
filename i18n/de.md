...
# v1.5.0 wurde veröffentlicht! 🎉 [Jetzt herunterladen](https://github.com/vladelaina/Catime/releases/latest) - `nur 995KB`！
</div>
...
<p align="center"> 
  Ein extrem leichtgewichtiges Windows-Countdown- und Pomodoro-Tool, geschrieben in <b>reinem C</b>, mit einer sauberen, transparenten Oberfläche,<br/>
  umfangreichen Anpassungsmöglichkeiten, leistungsstarken Schnellbedienungen und nahezu keinem Ressourcenverbrauch。
</p>
...
<div align="center" style="margin-bottom: 30px;">
  ...
  und 
  <a href="https://qm.qq.com/q/vjCduOQILI" target="_blank" style="text-decoration: none; font-weight: bold; color: #12B7F5;">QQ Gruppe（1079222265）</a>
</div>


## 🎨 Leistungsstarke Tray-Animationen

Dein Tray-Icon kann jetzt „lebendig“ werden! Catime bringt leistungsstarke anpassbare Animationen：

- Benutzerdefinierte Animationen：Unterstützt GIF、WebP sowie statische Bilder wie PNG und JPG als Tray-Icons。
- Systemstatusanzeige：Zeigt in Echtzeit CPU-Auslastung、Speichernutzung、Akkustand und Caps-Lock-Status an。
...
> [!TIP]
> Möchtest du mehr interessante Tray-Animationen finden？Du kannst unser Projekt [MemeTray](https://github.com/MemeTray/MemeTray) ansehen！



## 💫 [Plugins](https://github.com/vladelaina/Catime-Plugins)

> Plugins müssen nur Inhalte in die output.txt schreiben，Catime ist für die Anzeige verantwortlich，so einfach ist das。
...
> [!TIP]
> Möchtest du mehr praktische Plugins finden？Du kannst unser Projekt [Catime-Plugins](https://github.com/vladelaina/Catime-Plugins) ansehen！




## ❤️‍🔥 Bleib dran
> Gib uns einen Star und erlebe, wie sich dieses minimalistische Zeit-Tool aus reinem C weiterentwickelt，verpasse keine zukünftigen Updates！
  ...
  <table align="center">
    <tr>
      ...
      <td style="vertical-align: middle;">
        Kostenloser Windows-Code-Signierungsdienst wird von
        <a href="https://signpath.io">SignPath.io</a> bereitgestellt，Zertifikate werden von
        <a href="https://signpath.org/">SignPath Foundation</a> gesponsert。
      </td>
    </tr>
  </table>
</div>
...
- GitHub Releases
  ...
  Lade die neueste Version von [GitHub Releases](https://github.com/vladelaina/Catime/releases/latest) herunter。
...
## [📑 Anleitung](https://cati.me/guide)

- Linksklick auf das Tray-Icon：Zeit einstellen
- Rechtsklick auf das Tray-Icon：Menü öffnen
- Bearbeitungsmodus：Ziehen zum Verschieben，Scrollen zum Zoomen，🖱️ Rechtsklick zum Beenden des Bearbeitungsmodus

> Die Konfigurationsdatei befindet sich unter `%LOCALAPPDATA%\Catime\config.ini`

## ⚡ [Schriftoptimierung](https://vladelaina.github.io/Catime/tools/font-tool/)

Mit dem offiziellen [Schrift-Optimierungstool](https://vladelaina.github.io/Catime/tools/font-tool/) kann die Größe benutzerdefinierter Schriftarten um mehr als 90% reduziert werden。

> Da Catime hauptsächlich Zahlen und Symbole（`0-9`、`:`、`.`）anzeigt，werden die meisten Zeichen nicht benötigt。
>
> Empfehlung：Bitte bewahre die originale Schriftdatei als Backup auf。Zukünftige Updates könnten mehr Zeichen benötigen。

## 🛠️ Entwicklung

Voraussetzungen：Zum Erstellen von Catime werden MinGW und CMake benötigt。
...
# Windows - siehe untenstehende Konfigurationsanleitung
```

<details>
<summary>📋 Windows-Umgebungskonfiguration</summary>

### 📦 Erforderliche Tools

| Tool | Beschreibung | Empfohlenes Versionsformat | Download-Link |
| ---------- | ---------------------- | ------------------------------------------------------------- | --------------------------------------------------------------------------------- |
...
1. Lade `x86_64-<version>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` von [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest) herunter
2. Entpacke es nach `C:\mingw64`
3. Füge `C:\mingw64\bin` zur System-`PATH`-Umgebungsvariable hinzu：
   - Öffne：`Systemsteuerung → System → Erweiterte Systemeinstellungen → Umgebungsvariablen`
   - Finde `Path` unter den Systemvariablen und klicke auf „Bearbeiten“
   - Hinzufügen：`C:\mingw64\bin`

#### 2. CMake installieren
1. Lade `cmake-<version>-windows-x86_64.msi` von [CMake](https://cmake.org/download/) herunter und führe es aus
2. Wähle während der Installation „Add CMake to the system PATH“
...
# 🎁 [Catime unterstützen](https://cati.me/support)
...
## [✨ Danksagung](https://cati.me/#thanks)

Besonderer Dank an [猫屋敷梨梨Official](https://space.bilibili.com/26087398) für das wunderschöne Icon-Design。
...
Icon-Lizenz：
- Das Software-Icon wurde von [猫屋敷梨梨Official](https://space.bilibili.com/26087398) erstellt und alle Rechte vorbehalten。Ohne ausdrückliche Genehmigung des ursprünglichen Autors darf es nicht für kommerzielle Zwecke verwendet werden。
...
- Autor：[猫屋敷梨梨Official](https://space.bilibili.com/26087398)
  - Dynamische Wallpaper-Links：[猫屋敷梨梨「星之所在」曲绘夜晚版](https://steamcommunity.com/sharedfiles/filedetails/?id=3171487185) 与 [猫屋敷梨梨-「星之所在」曲绘黄昏版](https://steamcommunity.com/sharedfiles/filedetails/?id=3171483657)
---
